...
import { NavController, NavParams, IonicApp, ActionSheetController } from 'ionic-angular';
...
export class PersSetPage {
	...
	constructor(public navCtrl: NavController, public asCtrl:ActionSheetController, public app:IonicApp, public navParams: NavParams, public utils: Utils, public http: HttpService, public cv:CommonValidator) {
		this.initForm();
	}
